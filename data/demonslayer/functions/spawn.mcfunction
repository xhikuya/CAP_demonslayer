...
execute unless predicate demonslayer:in_selection as @e[type=zombie,tag=!custom,tag=!ds_checked] if predicate demonslayer:demonspawn_chance at @s run function demonslayer:demon/spawn
