...
scoreboard players add @s var4 0
...
scoreboard players add @s ds_var4 1
...
execute at @s[nbt=!{OnGround:0b},scores={var4=5}] run tp @s ~ ~ ~ facing entity @p feet
...
execute as @s[scores={var1=13,ds_cooldown=0}] at @s positioned ^ ^ ^2.2 positioned ~1.5 ~1.5 ~1.5 if entity @e[dx=-3,dy=-3,dz=-3,tag=!ds_this] run function demonslayer:ai/training/attack

tag @s remove ds_this
execute if score @s var1 matches 13.. run scoreboard players set @s var1 0
execute if score @s var4 matches 6.. run scoreboard players set @s var4 0
