...
execute if score @s[tag=!ds_um1] var1 matches 60.. if entity @p[distance=2..5] facing entity @p feet run function demonslayer:demon/bda/nezuko/exploding/exploding
execute if score @s[tag=!ds_um1] var1 matches 60.. run scoreboard players set @s var1 0
execute if score @s[tag=ds_um1] var1 matches 50.. if entity @p[distance=2..5] facing entity @p feet run function demonslayer:demon/bda/nezuko/exploding/exploding
execute if score @s[tag=ds_um1] var1 matches 50.. run scoreboard players set @s var1 0
