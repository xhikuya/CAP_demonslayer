...
execute unless score @s ds_formtime matches 1.. if score @s var1 matches 60.. if entity @p[distance=2..30] facing entity @p feet run function demonslayer:ai/demon/yahaba_choose
