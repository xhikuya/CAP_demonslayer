...
execute if score @s[scores={var2=20..,ds_formtime=0}] var1 matches 7 at @s positioned ^ ^ ^1.8 positioned ~1 ~1 ~1 if entity @e[dx=-2,dy=-2,dz=-2,tag=!ds_this] run function demonslayer:ai/demon/basic_atk
