...
execute if score @s[scores={var2=20..,ds_formtime=0}] var1 matches 10 at @s positioned ^ ^ ^1 positioned ~1 ~1 ~1 if entity @e[dx=-2,dy=-2,dz=-2,tag=!ds_this] run function demonslayer:demon/bda/basic/slash/summon_atk
tag @s remove ds_this
execute if score @s var1 matches 10.. run scoreboard players set @s var1 0