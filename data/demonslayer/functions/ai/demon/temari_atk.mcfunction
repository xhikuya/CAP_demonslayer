...
execute as @e[tag=ds_new] at @s run tp @s ~ ~ ~ facing entity @p feet
scoreboard players set @s[scores={ds_cooldown=1..}] ds_cooldown 40
scoreboard players set @s[scores={ds_cooldown=0}] ds_cooldown 50
