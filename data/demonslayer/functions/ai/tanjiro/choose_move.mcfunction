...
execute if entity @s[tag=!closerange,tag=!melee] if entity @p[distance=..15,gamemode=!creative] run tag @s add midrange
execute if entity @s[tag=!melee,tag=!closerange,tag=!midrange] if entity @p[distance=16..20,gamemode=!creative] run tag @s add longrange
