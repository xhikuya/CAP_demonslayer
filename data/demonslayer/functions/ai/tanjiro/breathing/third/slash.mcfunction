...
tag @s add immune
execute rotated ~ 0 positioned ~-2 ~-1 ~-2 as @e[dx=4,dz=4,dy=2,tag=!immune,predicate=demonslayer:target_slayer] if entity @s[nbt={HurtTime:0s}] run scoreboard players operation @s dmg = #ds:temp var1
tag @s remove immune
