...
tag @s add immune
execute positioned ~-2.4 ~-1.5 ~-2.4 as @e[dx=4.8,dz=4.8,dy=3,tag=!immune,predicate=demonslayer:target_slayer] if entity @s[nbt={HurtTime:0s}] run scoreboard players operation @s dmg = #ds:temp var1
tag @s remove immune