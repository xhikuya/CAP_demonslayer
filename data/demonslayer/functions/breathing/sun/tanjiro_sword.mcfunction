...
scoreboard players set @s[scores={ds_sunform=12..}] ds_sunform 1
...
scoreboard players set @s[scores={ds_sunform=4..,stat_control=10..11}] ds_sunform 1
scoreboard players set @s[scores={ds_sunform=5..,stat_control=12..13}] ds_sunform 1
scoreboard players set @s[scores={ds_sunform=6..,stat_control=14..15}] ds_sunform 1
scoreboard players set @s[scores={ds_sunform=7..,stat_control=16..17}] ds_sunform 1
scoreboard players set @s[scores={ds_sunform=8..,stat_control=18..19}] ds_sunform 1
...
execute if score @s[scores={ds_swap=6..}] ds_sunform matches 11 run tellraw @s {"text": "Water Breathing","color": "blue"}
...
execute if predicate core:click if score @s ds_sunform matches 11 run function demonslayer:breathing/water/tanj_switch
#>hello
