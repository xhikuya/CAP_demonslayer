execute store result score #ds:temp var1 run attribute @s generic.attack_damage get 14
...
execute if predicate demonslayer:enchants/sharpness_6 run scoreboard players add #ds:temp var1 30
execute if predicate demonslayer:enchants/sharpness_7 run scoreboard players add #ds:temp var1 35
...
data merge entity @e[tag=death_message,limit=1] {CustomName:'{"text": "died to fire breathing","color": "white"}'}