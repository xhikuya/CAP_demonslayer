...
execute if score #ds:temp var1 matches 601.. run scoreboard players set #ds:temp var1 600
...
data merge entity @e[tag=death_message,limit=1] {CustomName:'{"text": "died to thunder breathing","color": "white"}'}