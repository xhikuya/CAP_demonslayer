...
execute if entity @s[predicate=demonslayer:demon,nbt={SelectedItem:{tag:{Cap:{Kaigaku:1b}}}}] positioned ^ ^ ^1.4 positioned ~.7 ~.7 ~.7 as @e[tag=!immune,type=!#core:non_living,dx=-1.4,dz=-1.4,dy=-1.4] run effect give @s wither 5 5 true
