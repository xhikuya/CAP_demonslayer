...
scoreboard players set @s[scores={ds_fireform=5..}] ds_fireform 1
scoreboard players set @s[scores={ds_fireform=2..,stat_control=5..6}] ds_fireform 1
scoreboard players set @s[scores={ds_fireform=3..,stat_control=7..9}] ds_fireform 1
...
execute if score @s[scores={ds_swap=6..}] ds_fireform matches 4 run tellraw @s {"text": "Water Breathing","color": "blue"}
...
execute if predicate core:click if score @s ds_fireform matches 4 run function demonslayer:breathing/water/tanj_switch
