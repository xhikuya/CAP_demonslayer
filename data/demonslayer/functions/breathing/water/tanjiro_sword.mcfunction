...
scoreboard players set @s[scores={ds_waterform=5..,stat_control=15..16}] ds_waterform 1
...
execute if score @s[scores={ds_swap=6..}] ds_waterform matches 7 run tellraw @s {"text": "Hinokami Kagura","color": "dark_red"}
...
execute if predicate core:click if score @s[scores={stamina=18..,ds_cooldown=0}] ds_waterform matches 3 run function demonslayer:breathing/water/third_form1
...
execute if predicate core:click if score @s[scores={stamina=20..,ds_cooldown=0}] ds_waterform matches 4 run function demonslayer:breathing/water/5th/init
...
execute if predicate core:click if score @s[scores={stamina=16..,ds_cooldown=0}] ds_waterform matches 5 run function demonslayer:breathing/water/6th/init
