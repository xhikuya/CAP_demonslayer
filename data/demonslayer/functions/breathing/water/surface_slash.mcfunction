...
execute if score @s ds_formtime matches 5.. at @s positioned ^ ^ ^2 if entity @e[distance=..1] at @s run function demonslayer:breathing/water/slash
execute if score @s ds_formtime matches 5.. at @s positioned ^ ^ ^2 if entity @e[distance=..1] at @s run function demonslayer:breathing/water/surface_slash2
execute if score @s ds_formtime matches 5.. at @s positioned ^ ^ ^2 if entity @e[distance=..1] at @s run scoreboard players set @s ds_formtime 6
