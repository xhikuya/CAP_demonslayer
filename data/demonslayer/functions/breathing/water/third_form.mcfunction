...
execute if score @s ds_cooldown matches ..10 positioned ~2 ~2 ~2 if entity @e[nbt={HurtTime:0s},dx=-4,dy=-5,dz=-4,tag=!immune] run scoreboard players add @s ds_cooldown 10
