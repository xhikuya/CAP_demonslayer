...
tag @s add immune
execute rotated ~ 0 positioned ~-3 ~ ~-3 as @e[dx=6,dz=6,dy=7,tag=!immune] unless score @s dmg matches 1.. run scoreboard players operation @s dmg = #ds:temp var1
execute rotated ~ 0 positioned ~-3 ~ ~-3 as @e[dx=6,dz=6,dy=7,tag=!immune] unless score @s dmg matches 1.. run scoreboard players add @s ds_wisteria 50
