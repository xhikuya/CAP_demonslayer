...
execute if score @s var1 matches 3 positioned ~.5 ~.5 ~.5 as @e[tag=!ds_owner,dx=-1,dy=-1,dz=-1,type=!#core:non_living,tag=!ds_hitbox,scores={ds_lhit=0}] run scoreboard players operation @s dmg = @e[tag=ds_this] var2
