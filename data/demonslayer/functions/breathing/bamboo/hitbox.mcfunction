...
execute unless entity @e[tag=ds_hithis] run summon skeleton ~ ~-2 ~ {Tags:["ds_hitbox","ds_hithis","ds_hitnew","immune"],ActiveEffects:[{Id:11b,Duration:100000,Amplifier:10,ShowParticles:0b},{Id:14b,ShowParticles:0b,Amplifier:0,Duration:1000000}],Team:"ds_collide",Silent:1b,DeathLootTable:"minecraft:empty",IsChickenJockey:1b,NoGravity:1b,NoAI:1b}
