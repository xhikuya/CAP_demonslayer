...
scoreboard players set @s[scores={ds_waterform=4..}] ds_waterform 1
...
execute if score @s[scores={ds_swap=6..}] ds_waterform matches 3 run tellraw @s "3rd form"
...
execute if predicate core:click if score @s[scores={stamina=15..,ds_cooldown=0}] ds_waterform matches 3 run function demonslayer:breathing/water/third_form1
