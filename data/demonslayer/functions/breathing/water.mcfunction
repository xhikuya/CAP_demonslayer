...
scoreboard players set @s[scores={ds_waterform=7..}] ds_waterform 1
...
scoreboard players set @s[scores={ds_waterform=6..},advancements={demonslayer:slayer/demons/kill_demon50=false}] ds_waterform 1
...
execute if score @s[scores={ds_swap=6..}] ds_waterform matches 6 run tellraw @s {"text": "Eleventh Form: Dead Calm","color": "#0077D6"}
...
execute if score @s[scores={ds_waterform=6}] ds_formtime matches 5.. run function demonslayer:breathing/water/dead_calm/main
