...
execute as @e if score @s uuid = @e[tag=ds_this,limit=1,scores={var4=2}] var3 at @s unless block ~ ~1 ~ #airs run tp @s ~ ~1 ~

execute as @e if score @s uuid = @e[tag=ds_this,limit=1,scores={var4=2,var1=..50}] var3 at @s run effect give @s slow_falling 1 0 true
