function demonslayer:demon/bda/nezuko/m1/dmg

execute store result score @s uuid run data get entity @s UUID[0]
execute rotated ~ 0 run summon area_effect_cloud ^ ^ ^1.5 {Duration:10,Radius:0,RadiusPerTick:0,Tags:["ds_slash","ds_proj","ds_slew"]}
