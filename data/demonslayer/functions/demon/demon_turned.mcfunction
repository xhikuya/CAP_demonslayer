...
execute at @s unless data entity @s SpawnX run spreadplayers ~ ~ 1 100 under 50 true @s
execute at @s unless data entity @s SpawnX run spawnpoint @s
...
advancement revoke @s only demonslayer:demon_3
