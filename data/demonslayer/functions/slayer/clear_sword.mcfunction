...
execute as @a[predicate=!demonslayer:breathing/sun] run clear @s carrot_on_a_stick{FireBreathing:1b}
...
schedule function demonslayer:slayer/clear_sword 5s replace